...
declare const __VLS_export: import('vue').DefineComponent<SymbolTagManagerProps, {
    ...
    "action-success": (action: "update" | "delete" | "create" | "translation-config" | "translations", row?: SymbolTagRow | undefined) => any;
    ...
    "onAction-success"?: ((action: "update" | "delete" | "create" | "translation-config" | "translations", row?: SymbolTagRow | undefined) => any) | undefined;
}>, {

...
export type PositionListRequest<Row extends PositionRow = PositionRow> = (
  query: PositionListQuery,
  context: PositionRequestContext,
) => Promise<PositionListResult<Row>>

export type PositionTableColumns<Row extends PositionRow = PositionRow> =
  | ProTableColumn<Row>[]
...
export type PositionTableActionHandler<Row extends PositionRow = PositionRow> = (
  row: Row,
  context: PositionTableActionContext,
) => Promise<void> | void

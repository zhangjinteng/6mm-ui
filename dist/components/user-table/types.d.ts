...
export type UserListRequest<Row extends UserRow = UserRow> = (query: UserListQuery, context: UserRequestContext) => Promise<UserListResult<Row>>;
export type UserTableColumns<Row extends UserRow = UserRow> = ProTableColumn<Row>[] | ((defaultColumns: ProTableColumn<Row>[]) => ProTableColumn<Row>[]);
...
export type UserTableActionHandler<Row extends UserRow = UserRow> = (row: Row, context: UserTableActionContext) => Promise<void> | void;

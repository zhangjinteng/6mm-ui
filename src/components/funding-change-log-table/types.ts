...
export type FundingChangeLogListRequest<Row extends FundingChangeLogRow = FundingChangeLogRow> = (
  query: FundingChangeLogListQuery,
  context: { signal: AbortSignal },
) => Promise<FundingChangeLogListResult<Row>>

export type FundingChangeLogTableColumns<Row extends FundingChangeLogRow = FundingChangeLogRow> =
  | ProTableColumn<Row>[]
...
export interface FundingChangeLogTableExpose { reload: () => Promise<void> }

...
export type AccountChangeLogListRequest<Row extends AccountChangeLogRow = AccountChangeLogRow> = (query: AccountChangeLogListQuery, context: AccountChangeLogRequestContext) => Promise<AccountChangeLogListResult<Row>>;
export type AccountChangeLogTableColumns<Row extends AccountChangeLogRow = AccountChangeLogRow> = ProTableColumn<Row>[] | ((defaultColumns: ProTableColumn<Row>[]) => ProTableColumn<Row>[]);
export type AccountChangeLogTableQueryFields = QueryBarField[] | ((defaultFields: QueryBarField[]) => QueryBarField[]);
export type AccountChangeLogDetailHandler<Row extends AccountChangeLogRow = AccountChangeLogRow> = (row: Row) => Promise<void> | void;

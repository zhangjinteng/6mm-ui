...
export interface HistoryPositionRow extends TableRow {
  ...
  symbol?: string | null
  trade_fills?: { side?: string | null } | null
...
export type HistoryPositionListRequest<Row extends HistoryPositionRow = HistoryPositionRow> = (
  query: HistoryPositionListQuery,
  context: HistoryPositionRequestContext,
) => Promise<HistoryPositionListResult<Row>>

export type HistoryPositionTableColumns<Row extends HistoryPositionRow = HistoryPositionRow> =
  | ProTableColumn<Row>[]
...
export type HistoryPositionTableActionHandler<Row extends HistoryPositionRow = HistoryPositionRow> = (
  row: Row,
  context: HistoryPositionTableActionContext,
) => Promise<void> | void

...
export type MarginChangeLogListRequest<Row extends MarginChangeLogRow = MarginChangeLogRow> = (query: MarginChangeLogListQuery, context: MarginChangeLogRequestContext) => Promise<MarginChangeLogListResult<Row>>;
export type MarginChangeLogTableColumns<Row extends MarginChangeLogRow = MarginChangeLogRow> = ProTableColumn<Row>[] | ((defaultColumns: ProTableColumn<Row>[]) => ProTableColumn<Row>[]);
export type MarginChangeLogTableQueryFields = QueryBarField[] | ((defaultFields: QueryBarField[]) => QueryBarField[]);

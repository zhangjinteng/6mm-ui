...
export type UserAssetListRequest<Row extends UserAssetRow = UserAssetRow> = (query: UserAssetListQuery, context: UserAssetRequestContext) => Promise<UserAssetListResult<Row>>;
export type UserAssetTableColumns<Row extends UserAssetRow = UserAssetRow> = ProTableColumn<Row>[] | ((defaultColumns: ProTableColumn<Row>[]) => ProTableColumn<Row>[]);
...
export type UserAssetTableActionHandler<Row extends UserAssetRow = UserAssetRow> = (row: Row, context: UserAssetTableActionContext) => Promise<void> | void;

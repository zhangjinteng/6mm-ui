...
export type TradeFillListRequest<Row extends TradeFillRow = TradeFillRow> = (
  query: TradeFillListQuery,
  context: TradeFillRequestContext,
) => Promise<TradeFillListResult<Row>>

export type TradeFillTableColumns<Row extends TradeFillRow = TradeFillRow> =
  | ProTableColumn<Row>[]
...
export type TradeFillTableActionHandler<Row extends TradeFillRow = TradeFillRow> = (
  row: Row,
  context: TradeFillTableActionContext,
) => Promise<void> | void

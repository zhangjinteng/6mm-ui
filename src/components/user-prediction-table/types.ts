...
export type UserPredictionListRequest<Row extends UserPredictionRow = UserPredictionRow> = (
  query: UserPredictionListQuery,
  context: { signal: AbortSignal },
) => Promise<UserPredictionListResult<Row>>

export type UserPredictionTableColumns<Row extends UserPredictionRow = UserPredictionRow> =
  | ProTableColumn<Row>[]

...
export type FeeCommissionListRequest<Row extends FeeCommissionRow = FeeCommissionRow> = (
  query: FeeCommissionListQuery,
  context: FeeCommissionRequestContext,
) => Promise<FeeCommissionListResult<Row>>

export type FeeCommissionTableColumns<Row extends FeeCommissionRow = FeeCommissionRow> =
  | ProTableColumn<Row>[]
  | ((defaultColumns: ProTableColumn<Row>[]) => ProTableColumn<Row>[])

export type FeeCommissionTableQueryFields =
  | QueryBarField[]

...
import { CursorPaginationProps } from '../cursor-pagination';
import { PaginationSize } from '../pagination';
import { QueryBarField, QueryBarReturnContext, QueryBarValue } from '../query-bar';
import { TableColumn, TableKey, TableProps, TableRow, TableSortState } from '../table';
export interface ProTableColumn<Row extends TableRow = TableRow> extends TableColumn<Row> {
...
export interface ProTableCursorPaginationProps extends Pick<CursorPaginationProps, "currentPage" | "disabled" | "hasMore" | "hasPrevious" | "loading" | "size"> {
    pageSize?: number;
    rowCount?: number;
}

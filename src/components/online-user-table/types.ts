...
export type OnlineUserListRequest<Row extends OnlineUserRow = OnlineUserRow> = (
  query: OnlineUserListQuery,
  context: OnlineUserRequestContext,
) => Promise<OnlineUserListResult<Row>>

export type OnlineUserTableColumns<Row extends OnlineUserRow = OnlineUserRow> =
  | ProTableColumn<Row>[]

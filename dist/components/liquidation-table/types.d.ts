...
export type LiquidationListRequest<Row extends LiquidationRow = LiquidationRow> = (query: LiquidationListQuery, context: LiquidationRequestContext) => Promise<LiquidationListResult<Row>>;
export type LiquidationTableColumns<Row extends LiquidationRow = LiquidationRow> = ProTableColumn<Row>[] | ((defaultColumns: ProTableColumn<Row>[]) => ProTableColumn<Row>[]);
export interface LiquidationTableActionContext {
    reload: () => Promise<void>;
}
export type LiquidationTableActionHandler<Row extends LiquidationRow = LiquidationRow> = (row: Row, context: LiquidationTableActionContext) => Promise<void> | void;

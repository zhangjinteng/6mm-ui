...
export interface HedgingSymbolConfigResult {
  ...
  options: { accounts: HedgingSymbolAccountOption[]; exchanges: string[] };
}
...
export interface HedgingSymbolConfigLabels {
  account: string; agent: string; allAccounts: string; allAgents: string; allExchanges: string;
  allStatuses: string; allUnits: string; enabled: string; exchange: string; exit: string;
  firstTrigger: string; hedgeUnit: string; loading: string; noData: string; query: string;
  rebalance: string; reset: string; search: string; slippage: string; status: string;
  symbol: string; targetRatio: string; disabled: string; unitBase: string; unitUsdt: string;
}

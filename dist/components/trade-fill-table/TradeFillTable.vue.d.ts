...
import { TradeFillRow, TradeFillTableProps } from './types';
declare const __VLS_export: <Row extends TradeFillRow = TradeFillRow>(__VLS_props: NonNullable<Awaited<typeof __VLS_setup>>["props"], __VLS_ctx?: __VLS_PrettifyLocal<Pick<NonNullable<Awaited<typeof __VLS_setup>>, "attrs" | "emit" | "slots">>, __VLS_exposed?: NonNullable<Awaited<typeof __VLS_setup>>["expose"], __VLS_setup?: Promise<{
    props: import('vue').PublicProps & __VLS_PrettifyLocal<TradeFillTableProps<Row>> & (typeof globalThis extends {
    ...
    slots: {
        ...
        'cell-realized_pnl'?: (props: any) => any;
    } & {

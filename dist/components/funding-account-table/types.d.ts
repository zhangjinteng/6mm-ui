...
export type FundingAccountListRequest<Row extends FundingAccountRow = FundingAccountRow> = (query: FundingAccountListQuery, context: {
    signal: AbortSignal;
}) => Promise<FundingAccountListResult<Row>>;
export type FundingAccountTableColumns<Row extends FundingAccountRow = FundingAccountRow> = ProTableColumn<Row>[] | ((defaultColumns: ProTableColumn<Row>[]) => ProTableColumn<Row>[]);

import { LiquidationRow } from '../liquidation-table';
...
export type LiquidationTradeListRequest<Row extends LiquidationTradeRow = LiquidationTradeRow> = (query: LiquidationTradeListQuery, context: LiquidationTradeRequestContext) => Promise<LiquidationTradeListResult<Row>>;
export type LiquidationTradeHrefResolver = (id: LiquidationTradeIdentifier) => string | undefined;
export interface LiquidationTradesDialogProps<SummaryRow extends LiquidationTradeSummaryRow = LiquidationTradeSummaryRow, TradeRow extends LiquidationTradeRow = LiquidationTradeRow> {
